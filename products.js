...
function useApiData(data) {
  ...
  document.querySelector("#contentb").innerHTML +=
    data.results[0].genres[0].name;
  document.querySelector("#contentc").innerHTML += data.results[0].metacritic;
  document.querySelector(
    "#contentd"
  ).innerHTML += `<img src ="${data.results[0].short_screenshots[0].image}">`;
  ...
  document.querySelector("#contentg").innerHTML +=
    data.results[1].genres[0].name;
  document.querySelector("#contenth").innerHTML += data.results[1].metacritic;
  document.querySelector(
    "#contenti"
  ).innerHTML += `<img src ="${data.results[1].short_screenshots[0].image}">`;
  ...
  document.querySelector("#contentl").innerHTML +=
    data.results[16].genres[0].name;
  document.querySelector("#contentm").innerHTML += data.results[16].metacritic;
  document.querySelector(
    "#contentn"
  ).innerHTML += `<img src ="${data.results[16].short_screenshots[0].image}">`;
  ...
  document.querySelector("#contentq").innerHTML +=
    data.results[11].genres[0].name;
  document.querySelector("#contentr").innerHTML += data.results[11].metacritic;
  document.querySelector(
    "#contents"
  ).innerHTML += `<img src ="${data.results[11].short_screenshots[0].image}">`;
  ...
  document.querySelector("#contentv").innerHTML +=
    data.results[10].genres[0].name;
  document.querySelector("#contentw").innerHTML += data.results[10].metacritic;
  document.querySelector(
    "#contentx"
  ).innerHTML += `<img src ="${data.results[10].short_screenshots[0].image}">`;
  ...
  document.querySelector("#contentaa").innerHTML +=
    data.results[3].genres[0].name;
  document.querySelector("#contentbb").innerHTML += data.results[3].metacritic;
  document.querySelector(
    "#contentcc"
  ).innerHTML += `<img src ="${data.results[3].short_screenshots[0].image}">`;
}
